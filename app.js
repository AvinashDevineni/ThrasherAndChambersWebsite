...
function initializeTestimonials() {
    ...
    const testimonialsData = [
        ...
        {stars: 5, name: 'Sara Mark', 'date': '5/12/2025', review: "We live in Denver - but after being disappointed by every single advisor we worked with here, we moved all of our business to Thrasher and Chambers - and are delighted! My family has worked with them for decades, and they've always steered each of us in the right direction. They made the transfer easy and made great recommendations to protect and expand our assets in ways that make sense and are comfortable for us. In addition, they have helped several of my employees move and update multiple plans they had at previous workplaces, and that's been both smooth and beneficial as well. I'd give them more than 5 stars if that was an option! You won't be disappointed!", },
    ]
